...
void MyGLWidget::creaBuffers () 
{
  ...
  glm::vec3 colores[6];
  colores[0] = glm::vec3(1, 0.2, 0.9);
    colores[1] = glm::vec3(1, 0.2, 0.9);
    colores[2] = glm::vec3(1, 0.2, 0.9);
  colores[3] = glm::vec3(1, 0.2, 0.9);
    colores[4] = glm::vec3(1, 0.2, 0.9);
    colores[5] = glm::vec3(1, 0.2, 0.9);
...
void MyGLWidget::projectTransform(){
    ...
    if(isOrtho) Proj = glm::ortho(-radio, radio, -radio, radio, znear, zfar);
