...
void MyGLWidget::creaBuffers ()
{
  ...
  Vertices[3] = glm::vec3(-1, 0, 0.0);
  Vertices[4] = glm::vec3(0, 0, 0.0);
  Vertices[5] = glm::vec3(0, -1, 0.0);
  
  Vertices[6] = glm::vec3(-1, 0, 0.0);
  Vertices[7] = glm::vec3(0, 0, 0.0);
  ...
  Vertices2[1] = glm::vec3(1, 0, 0.0);
  Vertices2[2] = glm::vec3(0.8, 0, 0.0);
