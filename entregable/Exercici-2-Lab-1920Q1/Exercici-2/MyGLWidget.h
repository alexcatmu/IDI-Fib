...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    // VAO names
    GLuint VAO_Pil, VAO_Terra, VAO_Arbre, VAO_Patri;
    // Program
    ...
    glm::vec3 centreBaseArbre, centreBasePil, posPilota, centreBasePatri;
    float escalaPil, escalaArbre, escalaPatri;

    glm::vec3 centreEsc, obs, vrp, up;
    float radiEsc, ra, fov, zn, zf, distancia;
    float alfaini;
    float angleX, angleY;
