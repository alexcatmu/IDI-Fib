...
QT_MOC_LITERAL(1, 11, 9), // "enviaAlfa"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11) // "recibirAlfa"

    },
    "MyGLWidget\0enviaAlfa\0\0recibirAlfa"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->enviaAlfa((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->recibirAlfa((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::enviaAlfa)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::enviaAlfa(int _t1)
{
