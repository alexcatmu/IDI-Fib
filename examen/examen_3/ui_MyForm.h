...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(widget, SIGNAL(enviaCamara(bool)), checkBox, SLOT(setChecked(bool)));
        QObject::connect(checkBox, SIGNAL(clicked(bool)), widget, SLOT(recibeCamara(bool)));
