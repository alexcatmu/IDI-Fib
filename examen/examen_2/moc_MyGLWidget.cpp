...
QT_MOC_LITERAL(1, 11, 12), // "activaCamera"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 12), // "activaEscena"
QT_MOC_LITERAL(4, 38, 11), // "focusCamera"
QT_MOC_LITERAL(5, 50, 1), // "b"
QT_MOC_LITERAL(6, 52, 11) // "focusEscena"

    },
    "MyGLWidget\0activaCamera\0\0activaEscena\0"
    "focusCamera\0b\0focusEscena"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->activaCamera((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->activaEscena((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->focusCamera((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->focusEscena((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::activaCamera)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyGLWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::activaEscena)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::activaCamera(bool _t1)
{
...
// SIGNAL 1
void MyGLWidget::activaEscena(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
